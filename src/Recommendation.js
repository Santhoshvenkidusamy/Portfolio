...
const Recommendation = () => {
    ...
    const products = [
        ...
        },
        {
            ...
            name: 'Disha',
            description: 'Santhosh is a dedicated and results-oriented professional who consistently demonstrates strong technical abilities, problem-solving skills, and a commitment to delivering high-quality solutions. His ability to quickly understand complex requirements and translate them into efficient, scalable applications makes him a valuable asset. He approaches challenges with a positive attitude, takes ownership of his work, and is always eager to learn and adapt to new technologies and industry trends. I am confident that he will continue to excel in his career and make meaningful contributions wherever he works.',
            image: Disha,
            role: 'Data Analyst'
        },
        {
